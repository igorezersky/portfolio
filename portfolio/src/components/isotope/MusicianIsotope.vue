    ...
    <div class="row grid-items border-line-v">
      ...
      <div class="col col-d-6 col-t-6 col-m-12 grid-item music border-line-h">
        <div class="box-item">
          ...
          <div class="desc">
            <a href="#" class="name has-popup">Wilder Thoughs</a>
      ...
      <div class="col col-d-6 col-t-6 col-m-12 grid-item design border-line-h">
        <div class="box-item">
          ...
          <div class="desc">
            <a href="#popup-1" class="name has-popup-media">Stick with Me</a>
      ...
      <div class="col col-d-6 col-t-6 col-m-12 grid-item music border-line-h">
        <div class="box-item">
          ...
          <div class="desc">
            <a href="#" class="name has-popup">Jazzy Streets</a>
            <div class="category">Music</div>
          </div>
        </div>
      </div>
