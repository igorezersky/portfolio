    ...
    <div class="row grid-items border-line-v">
      ...
      <div class="col col-d-6 col-t-6 col-m-12 grid-item photo border-line-h">
        <div class="box-item">
          ...
          <div class="desc">
            <a href="images/wwork1.jpg" class="name has-popup-image"
              >Best Resumes Writing</a
            >
      ...
      <div class="col col-d-6 col-t-6 col-m-12 grid-item gallery border-line-h">
        <div class="box-item">
          ...
          <div class="desc">
            <a href="#gallery-1" class="name has-popup-gallery"
              >Gereal Travels Book</a
            >
